...
/**
 * The GWT default implementation for {@link GDialog}. This class providess also
 * built-in dialog methods showXXX() for message, confirm and input user
 * interactions.
 * 
 */
...
public class DefaultGDialog extends DefaultGFrame implements GDialog {
	...
	private static Image getIcon(int messageType, String imagePath) {
		// Image icon = new PNGImage(getImagePath(messageType, imagePath), 32,
		// 32);
		// return icon;
	...
	public void setContent(Widget widget) {
		throw new IllegalStateException("Warning: user the setMessage(Object message) method instead");
	}
	 ...
	 */
	public static void showConfirmDialog(UIObject parent, Object message, GDialogChoiceListener choiceListener) {
		showMessage(parent, message, null, QUESTION_MESSAGE, getOptions(YES_NO_CANCEL_OPTION_TYPE, null), null, choiceListener);
	}
	 ...
	 *            the choiceListener triggered after user selection
	 */
	public static void showConfirmDialog(UIObject parent, Object message, String title, int optionType, GDialogChoiceListener choiceListener) {
		showMessage(parent, message, title, QUESTION_MESSAGE, getOptions(optionType, null), null, choiceListener);
	}
	 ...
	 *            the choiceListener triggered after user selection
	 */
	public static void showConfirmDialog(UIObject parent, Object message, String title, int optionType, int messageType, GDialogChoiceListener choiceListener) {
		showMessage(parent, message, title, messageType, getOptions(optionType, null), null, choiceListener);
	}
	 ...
	 *            the choiceListener triggered after user selection
	 */
	public static void showConfirmDialog(UIObject parent, Object message, String title, int optionType, int messageType, String imagePath,
			GDialogChoiceListener choiceListener) {
		showMessage(parent, message, title, messageType, getOptions(optionType, null), imagePath, choiceListener);
	}
	 ...
	 *            the choiceListener triggered after user selection
	 */
	public static void showInputDialog(UIObject parent, Object message, GDialogChoiceListener choiceListener) {
		showInputDialog(parent, message, null, QUESTION_MESSAGE, getOptions(OK_CANCEL_OPTION_TYPE, null), null, null, null, choiceListener);
	}
	 ...
	 *            the choiceListener triggered after user selection
	 */
	public static void showInputDialog(UIObject parent, Object message, String title, Object initialValue, GDialogChoiceListener choiceListener) {
		showInputDialog(parent, message, title, QUESTION_MESSAGE, getOptions(OK_CANCEL_OPTION_TYPE, null), null, initialValue, null, choiceListener);
	}
	 ...
	 *            the choiceListener triggered after user selection
	 */
	public static void showInputDialog(UIObject parent, Object message, String title, Object initialValue, int messageType, GDialogChoiceListener choiceListener) {
		showInputDialog(parent, message, title, messageType, getOptions(OK_CANCEL_OPTION_TYPE, null), null, initialValue, null, choiceListener);
	}
	 ...
	 *            the choiceListener triggered after user selection
	 */
	public static void showInputDialog(UIObject parent, Object message, String title, Object initialValue, int messageType, String imagePath,
			GDialogChoiceListener choiceListener) {
		showInputDialog(parent, message, title, messageType, getOptions(OK_CANCEL_OPTION_TYPE, null), imagePath, initialValue, null, choiceListener);
	}
	...
	public static void showInputDialog(UIObject parent, Object message, String title, Object initialValue, Object[] selectionValues, int messageType,
		...
		showInputDialog(parent, message, title, messageType, getOptions(OK_CANCEL_OPTION_TYPE, null), imagePath, initialValue, selectionValues, choiceListener);
	}
	 ...
	 *            the choiceListener triggered after user selection
	 */
	public static void showInputDialog(UIObject parentFrame, Object message, String title, int messageType, Option[] options, String imagePath,
	 ...
	 *            the choiceListener triggered after user selection
	 */
	public static void showMessage(UIObject parent, Object message, GDialogChoiceListener choiceListener) {
		showMessage(parent, message, null, INFORMATION_MESSAGE, null, null, choiceListener);
	}
	 ...
	 *            the choiceListener triggered after user selection
	 */
	public static void showMessage(UIObject parent, Object message, String title, int messageType, GDialogChoiceListener choiceListener) {
		showMessage(parent, message, title, messageType, null, null, choiceListener);
	}

	public static void showOptionDialog(UIObject parent, Object message, String title, int optionType, int messageType, String imagePath, Object[] options,
	 ...
	 *            the choiceListener triggered after user selection
	 */
	public static void showMessage(UIObject parentFrame, Object message, String title, int messageType, Option[] options, String imagePath,
			GDialogChoiceListener choiceListener) {
		setDefaultDialogProperties(title, messageType);
		internalDialog.setParent(parentFrame);
		internalDialog.setMessage(message);
	...
	private void _show(boolean isInputDialog) {
		...
		if (parent != null) {
			GwmUtilities.diplayAtRelativeGivenWidgetCenter(getCurrentGDialog(), parent);
		} else {
	...
	private void buildContent(boolean isInputDialog) {
		if (message == null) {
			throw new IllegalStateException("Please use the GDialog.setMessage(Object) or verify your message object is not null");
		}
		Widget content = null;
		DefaultGDialog dialog = getCurrentGDialog();
		if (!isInputDialog) {
			content = new DialogPane(message, options, icon, choiceListener, dialog);
		} else {
			content = new InputDialogPane(message, options, icon, initialValue, selectionValues, choiceListener, dialog);
		}
	...
	class InputDialogPane extends DialogPane {
		...
		public InputDialogPane(Object message, Option[] options, Image icon, Object initialValue, Object[] selectionValues,
	...
	static class DialogPane extends Composite {
		...
		public DialogPane(Object message, Option[] options, Image icon, GDialogChoiceListener choiceListener, DefaultGDialog dialog) {
			this.choiceListener = choiceListener;
			this.dialog = dialog;
		...
		protected void buildUI(Object message, Option[] options, Image icon) {
			...
			if (message != null) {
				if (message instanceof String) {
					...
					throw new IllegalArgumentException("Error => The content message of the GDialog can be a Text or a Widget");
			...
			DOM.setStyleAttribute(optionsPanel.getElement(), "textAlign", "center");
			DOM.setStyleAttribute(optionsPanel.getElement(), "whiteSpace", "nowrap");
			for (int i = 0; i < options.length; i++) {
				final Option option = options[i];
				Button optionBtn = new Button(option.getValue().toString());
				optionBtn.addClickHandler(new ClickHandler() {
					@Override
					public void onClick(ClickEvent event) {
						if (choiceListener != null) {
							String inputValue = null;
							if (option.equals(OK_OPTION) && DialogPane.this instanceof InputDialogPane) {
								inputValue = ((InputDialogPane) DialogPane.this).getInputValue();
				...
				DOM.setStyleAttribute(optionBtn.getElement(), "margin", "1");
