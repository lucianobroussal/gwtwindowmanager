...
public class InputDialogScenarii extends AbstractScenarii {
	...
	public void runScenarii() {
		DefaultGDialog.showInputDialog(null, "What is your favorite hobby?", "Asking ...", "", new GDialogChoiceListener() {
	...
	protected Hyperlink createLink() {
		Hyperlink desktopDemoLink = new Hyperlink("Input Dialog", "input_dialog");
