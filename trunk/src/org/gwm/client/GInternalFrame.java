...
public interface GInternalFrame {
	 ...
	 * 
	 * @param modal if true the screen is disabled
	 */
     ...
     * @throws IllegalStateException if it is called before a call of one showXXX(...) method.
     * @see  <a href="http://code.google.com/webtoolkit/documentation/com.google.gwt.user.client.ui.Widget.html">GWT Widget</a>
     *
	 */
     ...
     * @param height
     *              Height in pixels
     * @throws IllegalStateException if it is called after a call of one showXXX(...) method
     */
	...
	/**
	 * Recomputes window height, useful when you change window content and do not
	 * want scrolling.
	 */
