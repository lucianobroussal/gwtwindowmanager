...
call env
@java -cp "%~dp0\..\gwm.jar;%~dp0\src;%~dp0\classes;%~dp0\src-samples;%GWT_HOME%/gwt-user.jar;%GWT_HOME%/gwt-dev-windows.jar" com.google.gwt.dev.GWTShell -out "%~dp0\www" %* org.gwm.samples.gwmdemo.GwmDemo/GwmDemo.html  -port 9090
