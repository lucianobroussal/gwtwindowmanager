...
public class ValidationError extends RemoteStatus {
	
	public ValidationError() {
		this(null);
	}

	public ValidationError(Attributes errors) {
		super();
		setAttributes(errors);
	...
	/* (non-Javadoc)
	 * @see org.gwm.splice.client.service.data.RemoteStatus#newInstance()
	 */
