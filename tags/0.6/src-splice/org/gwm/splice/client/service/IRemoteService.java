...
public interface IRemoteService {
	 ...
	 */
	void execute(String action, Attributes parameters, IResponseHandler responseHandler);
	
	/**
	 * Executes a POST on service.
	 */
	void execute(String action, RemoteObject dataObject, IResponseHandler responseHandler);
	 ...
	 */
	void execute(String action, Attributes parameters, IResponseHandler responseHandler, boolean raw);
